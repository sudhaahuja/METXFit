...
def cmodel(cid,nam,_f,_fOut, out_ws, diag):
  ...
  w_ratio_trig_up = target.Clone(); w_ratio_trig_up.SetName('w_weights_%s_mettrig_Up'%cid)
  ...
  w_ratio_trig_down = target.Clone(); w_ratio_trig_down.SetName('w_weights_%s_mettrig_Down'%cid)
  ...
  w_e_ratio_trig_up = target.Clone(); w_e_ratio_trig_up.SetName('w_e_weights_%s_mettrig_Up'%cid)
  ...
  w_e_ratio_trig_down = target.Clone(); w_e_ratio_trig_down.SetName('w_e_weights_%s_mettrig_Down'%cid)
  ...
  w_ttbar_ratio_trig_up = target.Clone(); w_ttbar_ratio_trig_up.SetName('w_weights_%s_mettrig_Up'%cid)
  ...
  w_ttbar_ratio_trig_down = target.Clone(); w_ttbar_ratio_trig_down.SetName('w_weights_%s_mettrig_Down'%cid)
  ...
  w_ttbar_e_ratio_trig_up = target.Clone(); w_ttbar_e_ratio_trig_up.SetName('w_ttbar_e_weights_%s_mettrig_Up'%cid)
  ...
  w_ttbar_e_ratio_trig_down = target.Clone(); w_ttbar_e_ratio_trig_down.SetName('w_ttbar_e_weights_%s_mettrig_Down'%cid)
